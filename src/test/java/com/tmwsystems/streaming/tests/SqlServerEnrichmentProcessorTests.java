...
public class SqlServerEnrichmentProcessorTests {
	...
	protected static final Logger LOG = LoggerFactory.getLogger(SqlServerEnrichmentProcessorTests.class);
	...
	public void testHREnrichmentNonSecureCluster() throws Exception {
		SqlServerEnrichmentProcessor enrichProcessor = new SqlServerEnrichmentProcessor();
